function Template4() {
  return (
    <div
      className="bg-gradient-to-br bg-white text-black shadow-lg rounded-lg overflow-hidden"
          ...
          <div className="p-8 w-2/3">
            ...
            <div className="mb-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-200">Company name | 2020-2022</p>
            ...
            <div className="mb-8">
              ...
              <div className="mb-4">
                ...
                <p className="text-gray-200">2016-2018</p>
                <p className="text-gray-200">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-10">
                <div className="mb-4">
                  ...
                  <p className="text-gray-200">Date Issued</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold">Certificate Name</h3>
                  <p>Issuing Organization</p>
